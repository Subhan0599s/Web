...
<div class="body-content blog-page outer-top-ts">
 ...
 <div class="col-xs-12 col-sm-9 col-md-9"> 
	...
	<h1>Premium template with unlimited colours, and fully Customizable</h1>
...
</div>					<div class="blog-write-comment outer-bottom-xs outer-top-vs">
	<div class="row">
		<div class="col-md-12">
...
<footer id="footer" class="footer color-bg">
  ...
  <div class="copyright-bar">
    <div class="container">
      ...
      <div class="col-xs-12 col-sm-12 no-padding copyright">© 2019 ThemesGround. All Rights Reserved. </div>
