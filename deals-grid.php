        ...
        <div class="side-menu side-menu-inner animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Health and Beauty</a>
                <ul class="dropdown-menu mega-menu">
                  <li class="yamm-content">
                    <div class="row">
                      <div class="col-xs-12 col-sm-12 col-lg-4">
              ...
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Kids and Babies</a> 
                <!-- /.dropdown-menu --> </li>
              <!-- /.menu-item -->
              
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Sports</a> 
                <!-- ================================== MEGAMENU VERTICAL ================================== --> 
                <!-- /.dropdown-menu --> 
                <!-- ================================== MEGAMENU VERTICAL ================================== --> </li>
              <!-- /.menu-item -->
              
              <li class="dropdown menu-item"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Home and Garden</a> 
                <!-- /.dropdown-menu --> </li>
              <!-- /.menu-item -->
          ...
          <div class="sidebar-filter"> 
            ...
            <div class="sidebar-widget wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
              ...
              <div class="sidebar-widget-body m-t-10">
                <div class="price-range-holder"> <span class="min-max"> <span class="pull-left">$200.00</span> <span class="pull-right">$800.00</span> </span>
                  ...
                  <input type="text" class="price-slider" value="200,410" data="value: '200,410'" style="display: none;">
                </div>
                <!-- /.price-range-holder --> 
            ...
            <div class="sidebar-widget product-tag wow fadeInUp outer-top-vs animated" style="visibility: visible; animation-name: fadeInUp;">
              ...
              <div class="sidebar-widget-body outer-top-xs">
                <div class="tag-list"> <a class="item" title="Phone" href="category.html">phone</a> <a class="item active" title="Vest" href="category.html">vest</a> <a class="item" title="Smartphone" href="category.html">smartphone</a> <a class="item" title="Furniture" href="category.html">furniture</a> <a class="item" title="T-shirt" href="category.html">shirt</a> <a class="item" title="Sweatpants" href="category.html">sweater</a> <a class="item" title="Sneaker" href="category.html">sneaker</a> <a class="item" title="Toys" href="category.html">toys</a> <a class="item" title="Rose" href="category.html">rose</a> </div>
                <!-- /.tag-list --> 
              </div>
              <!-- /.sidebar-widget-body --> 
            </div>
                  ...
                  <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="store"><a href="#">Flipmart</a></div>
                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              ...
                              <li class="lnk wishlist"> <a class="add-to-cart" href="deals-detail.html" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> </li>
                              <li class="lnk"> <a class="add-to-cart" href="deals-detail.html" title="Compare"> <i class="fa fa-signal"></i> </a> </li>
                            </ul>
                          </div>
                          <!-- /.action --> 
                        </div>
                   ...
                   <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                        <div class="store"><a href="#">Marazzo</a></div>
                   ...
                   <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                        <div class="store"><a href="#">Nexus</a></div>
                   ...
                   <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <!-- /.product-image -->
                        <div class="product-info text-left">
                        <div class="store"><a href="#">Qualis</a></div>
                  ...
                  <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                        <div class="store"><a href="#">Unicorn</a></div>
                          <h3 class="name"><a href="deals-detail.html">New and Refurbished Lenovo Laptops</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> $450.99 </span> <span class="price-before-discount">$ 800</span> </div>
                   ...
                   <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                        <div class="store"><a href="#">Tonrex</a></div>
                          <h3 class="name"><a href="deals-detail.html">The Crash Bad Instant Folding long Twin Bed</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> $450.99 </span> <span class="price-before-discount">$ 800</span> </div>
                  ...
                  <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                        <div class="store"><a href="#">Modern</a></div>
                          <h3 class="name"><a href="deals-detail.html">Hampton Bay LED Light Ceiling Exhaust Fan</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> $450.99 </span> <span class="price-before-discount">$ 800</span> </div>
                  ...
                  <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                         <div class="store"><a href="#">Harrier</a></div>
                          <h3 class="name"><a href="deals-detail.html">Timberland Men’s Thorton Waterproof Boots</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> $450.99 </span> <span class="price-before-discount">$ 800</span> </div>
                  ...
                  <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                         <div class="store"><a href="#">Datsun</a></div>
                          <h3 class="name"><a href="deals-detail.html">Buying a TV Is Easy When You Know These Terms</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> $450.99 </span> <span class="price-before-discount">$ 800</span> </div>
                  ...
                  <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                         <div class="store"><a href="#">Boxshop</a></div>
                          <h3 class="name"><a href="deals-detail.html">New and Refurbished Lenovo Laptops</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> $450.99 </span> <span class="price-before-discount">$ 800</span> </div>
                  ...
                  <div class="item">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                         <div class="store"><a href="#">Altras</a></div>
                          <h3 class="name"><a href="deals-detail.html">New and Refurbished Lenovo Laptops</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> $450.99 </span> <span class="price-before-discount">$ 800</span> </div>
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-9 col-lg-9">
                          <div class="product-info">
                            <h3 class="name"><a href="deals-detail.html">Floral Print Buttoned</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> $450.99 </span> <span class="price-before-discount">$ 800</span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Suspendisse posuere arcu diam, id accumsan eros pharetra ac. Nulla enim risus, facilisis bibendum gravida eget, lacinia id purus. Suspendisse posuere arcu diam, id accumsan eros pharetra ac. Nulla enim risus, facilisis bibendum gravida eget. Suspendisse posuere arcu diam, id accumsan eros pharetra ac. Nulla enim risus, facilisis bibendum gravida eget, lacinia id purus. Suspendisse posuere arcu diam, id accumsan eros pharetra.</div>
