         ...
         <div class="category-product stores-list">
                <div class="row coupons-deals">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6 wow fadeInUp">
                   <div class="item">
                        <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 logo-img">
                          <img class="img-responsive" src="assets/images/brands/brand2.png" alt="">
                          </div>
                          <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                         <h3><a href="#">Carols Daughter</a></h3>
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                          </div>
                          </div>
                        </div>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6 wow fadeInUp">
                   <div class="item">
                        <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 logo-img">
                          <img class="img-responsive" src="assets/images/brands/brand3.png" alt="">
                          </div>
                          <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6 wow fadeInUp">
                   <div class="item">
                        <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 logo-img">
                          <img class="img-responsive" src="assets/images/brands/brand4.png" alt="">
                          </div>
                          <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                         <h3><a href="#">Baseball Savings</a></h3>
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                          </div>
                          </div>
                        </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-6 wow fadeInUp">
                  <div class="item">
                        <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 logo-img">
                          <img class="img-responsive" src="assets/images/brands/brand5.png" alt="">
                          </div>
                          <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                         <h3><a href="#">Ashford</a></h3>
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                          </div>
                          </div>
                        </div>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6 wow fadeInUp">
                   <div class="item">
                        <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 logo-img">
                          <img class="img-responsive" src="assets/images/brands/brand6.png" alt="">
                          </div>
                          <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                         <h3><a href="#">Callaway Golf</a></h3>
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                          </div>
                          </div>
                        </div>
